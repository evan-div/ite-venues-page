...
<style>
    /* ITC Avant Garde Gothic — self-hosted */
    @font-face {
      font-family: 'ITC Avant Garde Gothic';
      src: url('/wp-content/uploads/venues/fonts/ITC Avant Garde Gothic CE Book.otf') format('opentype');
      font-weight: 400; font-style: normal; font-display: swap;
    }
    @font-face {
      font-family: 'ITC Avant Garde Gothic';
      src: url('/wp-content/uploads/venues/fonts/ITC Avant Garde Gothic CE Book Oblique.otf') format('opentype');
      font-weight: 400; font-style: italic; font-display: swap;
    }
    @font-face {
      font-family: 'ITC Avant Garde Gothic';
      src: url('/wp-content/uploads/venues/fonts/ITC Avant Garde Gothic Medium.otf') format('opentype');
      font-weight: 500; font-style: normal; font-display: swap;
    }
    @font-face {
      font-family: 'ITC Avant Garde Gothic';
      src: url('/wp-content/uploads/venues/fonts/ITC Avant Garde Gothic Medium Oblique.otf') format('opentype');
      font-weight: 500; font-style: italic; font-display: swap;
    }
    @font-face {
      font-family: 'ITC Avant Garde Gothic';
      src: url('/wp-content/uploads/venues/fonts/ITC Avant Garde Gothic CE Demi.otf') format('opentype');
      font-weight: 600; font-style: normal; font-display: swap;
    }
    @font-face {
      font-family: 'ITC Avant Garde Gothic';
      src: url('/wp-content/uploads/venues/fonts/ITC Avant Garde Gothic Bold.otf') format('opentype');
    ...
    :root {
      ...
      --grey:    #8a8d99;
      --card-bg: #111116;
      --font:    'ITC Avant Garde Gothic', 'Century Gothic', Arial, sans-serif;
      --venues-grid-cols: 3;
  ...
  <script type="text/babel">
    ...
    function App() {
      ...
      const filtered = useMemo(() => {
        const list = filter === 'all' ? others : others.filter((v) => v.region === filter);
